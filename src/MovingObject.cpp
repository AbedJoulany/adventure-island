...
MovingObject::MovingObject(const float width, const float height, const std::shared_ptr<Board>& board) :
    m_Board(board),
    m_Width(width),
    m_Height(height)
{
...
void MovingObject::updatePosition(const float gravity)
{
...
float MovingObject::bufferedRoundoff(float i) const
{
